...
export default defineComponent({
  ...
  setup() {
    ...
    const sizeValues: Ref<string[]> = ref(Object.keys(Size));
      ...
      if (this.product.id) {
        this.productService()
          ...
          .then(param => {
            this.isSaving = false;
            this.previousState();
            this.alertService.showInfo(this.t$('jhipsterCommerceApp.product.updated', { param: param.id }));
          })
          .catch(error => {
            this.isSaving = false;
        ...
        this.productService()
          ...
          .then(param => {
            this.isSaving = false;
            this.previousState();
            this.alertService.showSuccess(this.t$('jhipsterCommerceApp.product.created', { param: param.id }).toString());
          })
          .catch(error => {
            this.isSaving = false;
            this.alertService.showHttpError(error.response);
